...
#include "../../Trajektoria_v03/savedialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SaveDialog_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 79, 20)
    ...
    "SaveDialog\0ustaw_tekst\0\0on_pB_zapisz_clicked\0"
    "on_lE_nazwa_pliku_textEdited\0arg1\0"
    "on_pB_anuluj_clicked\0"
};
...
void SaveDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->ustaw_tekst((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->on_pB_zapisz_clicked(); break;
        case 3: _t->on_pB_anuluj_clicked(); break;
        default: ;
        }
        ...
        {
            typedef void (SaveDialog::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SaveDialog::ustaw_tekst)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject SaveDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SaveDialog.data,
      qt_meta_data_SaveDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SaveDialog.stringdata))
...
// SIGNAL 0
void SaveDialog::ustaw_tekst(QString _t1)
{
